...
var favoriteBook = Book(title: "Maze Runner", author: "James Dashner", pages: 150, price: 9.99)
...
struct Laptop {
    ...
    let yearPurchased: Int
}

var first = Laptop(repairCount: 2, yearPurchased: 2009)
var second = Laptop(repairCount: 4, yearPurchased: 2012)
/*:
...
var heightVarIn = Height(heightInInches: 65)
var heightVarCm = Height(heightInCentimeters: 165.1)
print(heightVarCm.heightInInches)
print(heightVarIn.heightInCentimeters)
