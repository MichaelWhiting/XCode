...
class Fighter: Spaceship {
    ...
    func fire() {
        if remainingFirePower > 0 {
            ...
            print("You have no more remaining firepower")
        }
    }
}
...
var destroyer = Fighter(name: "Destroyer", health: 15, position: 0, weapon: "Laser", remainingFirePower: 10)
...
print("falcon isn't in this same script, plus falcon is a spaceship, not a destroyer")
