...
var michael = User(name: "Michael", age: 17, height: 72, weight: 200, activityLevel: 3)
print(michael)
...
let feetD = Distance(feet: 5249.344)
let metersD = Distance(meters: 1600)
print(feetD)
print(metersD)
