...
//
//  Created by Michael Whiting on 10/25/22.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func shareButtonTapped(_ sender: UIButton) {
        ...
        let activityController = UIActivityViewController(activityItems: [image, "Picture of mountains"], applicationActivities: nil)
    ...
    @IBAction func emailButtonTapped(_ sender: UIButton) {
        ...
        mailComposer.setToRecipients(["michael.whiting7526@stu.mtec.edu"])
