...
func createUser() -> User? {
    ...
    let newUser = User(firstName: firstnameTextField, lastName: lastNameTextField, age: ageTextField)
    return newUser
}
...
if let newUser = newUser {
    print("First Name: \(newUser.firstName), Last Name: \(newUser.lastName), Age: \(newUser.age)")
}
/*:
