...
func breakLunchDin(timeOfMeal: String) -> Meal? {
    if let meal = meals[timeOfMeal] {
        print("User has logged this meal!")
        return meal
    } else {
        print("User has NOT logged this meal yet!")
        return nil
    }
}

breakLunchDin(timeOfMeal: "Breakfast")
