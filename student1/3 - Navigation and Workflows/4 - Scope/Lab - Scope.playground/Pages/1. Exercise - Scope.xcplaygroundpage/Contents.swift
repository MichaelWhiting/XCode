...
//print("The value of foo is \(foo)")
// because the print statement is outside of the scope of "foo"
...
// it will print because there is an "x" variable for each of the print statements
...
greeting(greeting: nil, name: name)
greeting(greeting: "Hi there", name: name)
