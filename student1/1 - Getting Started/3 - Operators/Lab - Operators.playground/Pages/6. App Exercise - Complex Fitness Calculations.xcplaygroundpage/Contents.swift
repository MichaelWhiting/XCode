 ...
 */
//let tempInFahrenhiet = 98.6
//let tempInCelsius = (tempInFahrenhiet - 32) * (5.0/9.0)

//print(tempInCelsius) // I don't know why this one isn't working, but it says it won't work in the output.
/*:
