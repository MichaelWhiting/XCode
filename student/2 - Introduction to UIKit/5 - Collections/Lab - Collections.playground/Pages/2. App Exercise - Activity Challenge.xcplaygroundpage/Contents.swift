 ...
 */
var walkingChal: [String] = ["walk mile within 15 minutes", "walk 10000 steps"]
var runningChal: [String] = ["run mile within 9 minutes", "running 5000 steps"]
...
var challenges: [[String]] = [walkingChal, runningChal]
...
if committed.isEmpty {
    ...
    print("The challenge you have chosen is <INSTERT CHOSEN CHALLENGE>.")
} else {
