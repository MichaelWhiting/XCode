...
progressUpdate(steps: 2001, goal: 10000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    if goalTime / currentTime == totalDistance / currentDistance || goalTime / currentTime > totalDistance / currentDistance {
        print("Keep it up!")
    } else {
...
pacing(currentDistance: 7.5, totalDistance: 15.0, currentTime: 30, goalTime: 60)
/*:
